...
from page_objects.interview_scheduler_main_page import Interview_Scheduler_Main_Page
...
class PageFactory():
    ...
    def get_page_object(page_name,base_url=conf.base_url_conf.base_url):
        ...
        if page_name in ["main page","main","landing","landing page"]:
            test_obj = Interview_Scheduler_Main_Page(base_url=base_url)
        ...
        elif page_name == "interview scheduler main page":
            test_obj = Interview_Scheduler_Main_Page(base_url=base_url)
